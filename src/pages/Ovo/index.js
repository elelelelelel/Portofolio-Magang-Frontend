...
import { ChevronDown, OvoLogo } from "../../assets";
import { ActionSheet, NavBar, SelectPayment } from "../../components";
import EwalletCard from "../../components/molecules/EwalletCard";

class Ovo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      numInput: null,
      pulsaList: [
        { id: 1, title: "SALDO OVO 20rb", price: "20.950", point: 80 },
        { id: 2, title: "SALDO OVO 25rb", price: "25.950", point: 80 },
        { id: 3, title: "SALDO OVO 50rb", price: "50.950", point: 80 },
        { id: 4, title: "SALDO OVO 75rb", price: "75.950", point: 80 },
        { id: 5, title: "SALDO OVO 100rb", price: "100.950", point: 80 },
      ],
      selected: null,
      show: false,
      paymentShow: false,
