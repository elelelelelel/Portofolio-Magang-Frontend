...
class PulsaSMS extends Component {
	constructor(props){
		super(props)
		this.state = {
			numInput: null,
			pulsaList: [
				{ id: 1, title: 'ALL Nelpon 20mnt 7hr', price: 5650, point: 80 },
				{ id: 2, title: 'All Nelpon 60mnt 30hr', price: 14999, point: 80 },
				{ id: 3, title: 'ALL Nelpon 150mnt 30hr', price: 30750, point: 80 },
			],
			selected: null,
			show: false,
			paymentShow: false,
